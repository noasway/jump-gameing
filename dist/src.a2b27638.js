...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/people.js":[function(require,module,exports) {
"use strict";
...
var People = /*#__PURE__*/function () {
  function People(elId, x, y, r) {
    ...
    _defineProperty(this, "orignLY", void 0);
    this.locationX = x;
    this.locationY = y;
    this.radius = r;
  ...
  _createClass(People, [{
    ...
    value: function up() {
      ...
      var timer = setInterval(function () {
        var distance = _this.speed * interval + 0.5 * _this.acceleration * interval * interval;
        _this.speed = _this.speed + _this.acceleration * interval;
        _this.locationY -= distance;
        _this.draw();
        if (_this.speed <= 0) {
          clearInterval(timer);
          _this.down();
    ...
    value: function down() {
      ...
      var interval = 0.01;
      var timer = setInterval(function () {
        var distance = _this2.speed * interval - 0.5 * _this2.acceleration * interval * interval;
        _this2.speed = _this2.speed - _this2.acceleration * interval;
        _this2.locationY += distance;
        _this2.draw();
        if (_this2.locationY >= _this2.orignLY) {
          clearInterval(timer);
        }
      }, interval * 1000);
    }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44699" + '/');
